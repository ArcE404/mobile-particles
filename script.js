...
window.addEventListener('load', function() {
    ...
    class Effect{
        constructor(width, height){
            ...
            this.y = this.centerY -  this.imgaeHeight * 0.5;
            this.gap = 2;
            this.mouse = {
                radius: 5000,
                x: undefined,
        ...
        init(context){
            context.drawImage(this.image, this.x, this.y, this.imageWidth, this.imgaeHeight);
        ...
        draw(context){
            this.particleArray.forEach(value => {
                value.draw(context);
            });
        }
        update(){
    ...
    // ctx.drawImage(image, 700,200, 600, 500);
});
